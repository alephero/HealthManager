...
namespace HealthManager
{
    public class HealthForm:Form
    {
        ...
        private void CreateControls()
        {
            ...
            var goalsButton = new Button
            {
                Text = "Цели и рекомендации",
                Location = new System.Drawing.Point(90, 80),
                Size = new System.Drawing.Size(180, 25),
                Name = "goalsButton"
            };
        ...
        {
            var goalsForm = new GoalsForm(
                healthManager.GetActivityTracking(),  // нужно добавить этот метод
                healthManager.GetNutritionTracking(), // нужно добавить этот метод
                healthManager.GetSleepTracking()      // нужно добавить этот метод
            );
